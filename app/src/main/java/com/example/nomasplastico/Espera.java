...
public class Espera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        montostr = getIntent().getStringExtra("monto");
    ...
    private void siguiente(){
        Intent i = new Intent(this, Clave.class);
        i.putExtra("monto", montostr);
        i.putExtra("password", receivedPass);
        startActivity(i);
    }
    ...
    private void receiveMessageFromDevice(Intent intent) {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) {
            ...
            // Mensaje recibido desde la tarjeta
            receivedPass = new String(ndefRecord_0.getPayload());
            siguiente();
        }
    }
